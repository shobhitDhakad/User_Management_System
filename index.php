<?php
require_once 'db.php'; // Ensure your database connection is correct
...
if (isset($_POST['submit'])) {
    ...
    // If no validation errors, check if the user exists
...
<html lang="en">
  ...
  <head>
    ...
    <title>USER MANAGEMENT | Login Page</title>
        ...
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign in to start your session</p>
            <form action="login.php" method="post">              
              ...
              <input type="email" 
                class="form-control <?php echo (!empty($emailErr)) ? 'borderRed' : ''; ?>" 
              ...
              <div class="input-group mb-3">
              <input type="password"  
                class="form-control <?php echo (!empty($passwordErr)) ? 'borderRed' : ''; ?>" 
                id="pwd" 
                name="password">
